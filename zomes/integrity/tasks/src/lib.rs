...
pub fn validate(op: Op) -> ExternResult<ValidateCallbackResult> {
    match op.flattened::<EntryTypes, LinkTypes>()? {
                ...
                OpUpdate::Entry { app_entry, action } => {
                    ...
                    match app_entry {
                        EntryTypes::Task(task) => {
                            ...
                            let original_task = match Task::try_from(
                                original_app_entry,
                            ) {
                                Ok(entry) => entry,
                                Err(e) => {
                                    return Ok(
                                        ValidateCallbackResult::Invalid(
                                            format!("Expected to get Task from Record: {e:?}"),
                                        ),
                                    );
                                }
                            };
        ...
        FlatOp::RegisterCreateLink {
            ...
            match link_type {
                LinkTypes::AssigneeToTasks => {
                    validate_create_link_assignee_to_tasks(
                        action,
                        base_address,
                        target_address,
                        tag,
                ...
                LinkTypes::Dependency => {
                    validate_create_link_task_to_tasks(
                        action,
                        base_address,
                        target_address,
                        tag,
                ...
                LinkTypes::TaskUpdates => {
                    validate_create_link_task_updates(
                        action,
                        base_address,
                        target_address,
                        tag,
                ...
                LinkTypes::UnfinishedTasks => {
                    validate_create_link_unfinished_tasks(
                        action,
                        base_address,
                        target_address,
                        tag,
        ...
        FlatOp::RegisterDeleteLink {
            ...
            match link_type {
                LinkTypes::AssigneeToTasks => {
                    validate_delete_link_assignee_to_tasks(
                        action,
                        original_action,
                        base_address,
                        target_address,
                ...
                LinkTypes::Dependency => {
                    validate_delete_link_task_to_tasks(
                        action,
                        original_action,
                        base_address,
                        target_address,
                ...
                LinkTypes::TaskUpdates => {
                    validate_delete_link_task_updates(
                        action,
                        original_action,
                        base_address,
                        target_address,
                ...
                LinkTypes::UnfinishedTasks => {
                    validate_delete_link_unfinished_tasks(
                        action,
                        original_action,
                        base_address,
                        target_address,
